...
alias di='docker images | grep --color'
alias dr='docker run --rm -it'

case $(uname -s) in
    Linux)
        alias ls='/bin/ls -F --color=auto'
        alias l='/bin/ls -lhF --color=auto'
        alias ll='/bin/ls -lhF --color=auto'
        alias lla='/bin/ls -lahF --color=auto'
